// IA de entidades de la simulación local.
// Usa la misma taxonomía de game/js/systems/entities.js:
...
//
// Archivo DUAL (patrón de sim/fisica.js): corre en el entorno Node de pruebas y en el NAVEGADOR (window.Entidades, para el
...
const { MapGen, FOV } = esNode ? require('./mundo-node') : window;
